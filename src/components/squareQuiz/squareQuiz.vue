<template>
    ...
    <div class="quiz-container">
      ...
      <div class="square-container">
        <div class="square" v-for="(square, index) in squares" :key="square.id" :style="square.style" :class="{'selected' : square.selected}" @click="selectSquare(index)"></div>
      </div>
    </div>
 </div>
 </template>
